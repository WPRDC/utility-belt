...
if len(sys.argv) < 3:
    ...
    current_url = get_resource_parameter(site,resource_id,'url',API_key)
    ...
    print("\nSetting URL to {}...".format(url))
    set_resource_parameters_to_values(site,resource_id,['url'],[url],API_key)
